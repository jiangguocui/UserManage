...
<body>
	<div class="userinfo">
		<form action="<%=basePath%>modifyinfo${tuser.id}.do?t=0" id="modifyinfo">
		<table>
			<tbody>
				<tr>
				...
				<tr>
					...
					<td><span>学校：</span><span><input type="text" name="userSchool" value="${tuser.userSchool}"></span></td>
				</tr>
				<tr>
					<td><span>电话：</span> <span><input type="text" name="userPhone" value="${tuser.userPhone }" id="userPhone"></span>
					<span class="erro" id="phone"></span>
					</td>
					<td><span>邮箱：</span><span><input type="text" name="userEmail" value="${tuser.userEmail }" id="userEmail"></span>
					<span class="erro" id="email"></span>
					</td>
				</tr>
					<td><span>工作：</span> <span><input type="text" name="job" value="${tuser.job }"></span></td>
					<td><span>公司：</span><span><input type="text" name="company" value="${tuser.company }"></span></td>
				</tr>
				<tr>
					<td></td>
