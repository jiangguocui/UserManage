...
<body>
	<div class="widget">
		<div class="widget-head">
			<a href="javascript:;" data-target="#mymodal" data-toggle="modal">添加
				</button>
		...
		<div class="widget-content">
				...
				<tbody>
					...
					<c:forEach items="${degrees}" var="items">
						<tr>
							...
							<td><a data-target="#modifymodal" data-toggle="modal"
								href="javascript:;" onclick="tomodifyDegree(${items.id})">修改</a>
								&nbsp;&nbsp;|&nbsp;&nbsp; <a
								href="<%=basePath%>manager/deleteDegree${items.id}.html?record=${record}"
			...
			<div class="widget-foot">
				...
				<ul class="pagination pull-right">
					<li><a href="<%=basePath%>manager/tolistDegree?record=1">首页</a></li>
					<c:if test="${allPage<=5&&allPage>0}">
						<c:forEach begin="1" end="${allPage}" step="1" var="page">
							<li><a href="<%=basePath%>manager/tolistDegree?record=${page}"
					...
					<li><a href="<%=basePath%>manager/tolistDegree?record=${allPage}">尾页</a></li>
				</ul>
				<div class="clearfix"></div>
			</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">添加学历</h4>
				</div>
				<form action="<%=basePath%>manager/addDegree" id="addDegree">
					<div class="modal-body">
						学历名称：<input name="name" type="text" id="adname"> <span
							class="erro" id="dname"></span>
					</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">修改学历</h4>
				</div>
				<form action="<%=basePath%>manager/modifyDegree.html" id="modifyDegree">
					<input type="hidden" name="id" id="degreeId"> <input
						type="hidden" name="record" value="${record}">
					<div class="modal-body">
						学历名称：<input name="name" type="text" id="name"> <span
							class="erro" id="mdname"></span>
					</div>
					<div class="modal-footer">
