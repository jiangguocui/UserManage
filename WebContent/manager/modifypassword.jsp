...
<body>
	<div class="userinfo">
		<form action="<%=basePath%>manager/modifyMpassword${mloginUser.managerId}.do" id="mpwd">
		<table>
			<tbody>
				<tr>
				...
				<tr>
					...
					<td><span>确认密码：</span></td> <td><span><input type="text" name="confirmPassword" value="" id="confirmPassword"></span>
